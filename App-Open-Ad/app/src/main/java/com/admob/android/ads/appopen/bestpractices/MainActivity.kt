...
import com.admob.android.ads.appopen.bestpractices.GoogleMobileAdsConsentManager.Companion.TEST_DEVICE_HASHED_ID
import com.admob.android.ads.appopen.bestpractices.databinding.ActivityMainBinding
    ...
    private fun initializeMobileAdsSdk() {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            MobileAds.initialize(this@MainActivity) { initializationStatus ->
                ...
                AppOpenAdManager(this@MainActivity).apply {
